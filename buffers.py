...
# TODO: Having these values in an ascii file like this (with a ton of newlines) is not ideal.
#       For space, it would be better to have them in a binary file, and read them in as bytes.
